...
export default function Cart() {
  ...
  /*Almacenamiento y recorrido para los distintos hoteles */
  useEffect(() => {
    ...
    const completeReservations = storedReservations.map((reservation) => {
      ...
      const hotel = destination?.hotels.find(
  ...
  return (
    <>
      ...
      <div className="cart__container">
        <h2>
          Carrito de Reservas <i className="bx bx-cart"></i>
        </h2>
        ...
        {reservations.length > 0 && (
          <div className="cart__actions">
            <button
              onClick={confirmAllReservations}
              className="cart__confirm-all cart__hotel--confirm-add"
            >
              Confirmar todas las reservas
            </button>
            <button
              onClick={deleteAllReservations}
              className="cart__delete-all cart__hotel--confirm-delete"
            >
