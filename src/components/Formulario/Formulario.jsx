...
export default function Formulario() {
  ...
  /*Function para validar el formulario en donde tenemos que el formulario 
  debe contener un nombre, un teléfono, un correo
  y un asunto manejando los errores que pueda presentar*/
  const validateForm = () => {
    const newErrors = {};
 ...
 /*Actualiza los datos del formulario */
  ...
  /*Realiza el envío del formulario si esta todo correcto */
  ...
  return (
    <form className="form__container" onSubmit={handleSubmit}>
      ...
      <li className="form__container--list">
        {errors.asunto && <p className="error">{errors.asunto}</p>}
        <textarea
          name="asunto"
